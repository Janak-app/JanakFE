  ...
  return (
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <div className="flex-1 max-w-3xl mx-auto w-full px-4 pb-32">
        <h2 className="text-lg font-bold text-[#111827] mt-4">Payment Method</h2>
        <p className="text-xs text-[#6B7280] mt-1 mb-4">Choose how you&apos;d like to pay</p>
        ...
        <div className="flex flex-col gap-2.5">
          {METHODS.map(({ key, label, sub, Icon }) => {
            ...
            return (
              ...
              >
                <div className={`w-5 h-5 rounded-full border-2 flex items-center justify-center shrink-0 ${active ? "border-[#1A4F9C]" : "border-[#D1D5DB]"}`}>
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-[#E5E7EB] px-4 py-3 pb-6 z-20">
        <div className="max-w-3xl mx-auto">
          <Button label="Continue to Review" onClick={() => router.push("/checkout/review")} />
        </div>
      </div>
    </div>
  );
